...
const ElevenPlusPreparation = () => {
  ...
  const handleScrollToPricing = () => {
    const pricingSection = document.getElementById('eleven-plus-pricing')
    if (pricingSection) {
  ...
  const pricingPlans = [
    {
      title: '11+ Specialist Classes',
      popular: true,
      pricePrimary: '25',
      pricePrimaryLabel: '/Week',
      priceSecondary: '£ 100/ Monthly',
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
            11+ Learning, Built For Success
          </h1>
          <h2 className="text-xl md:text-2xl font-semibold text-white/95 mb-4">
            Focused 11+ Preparation For Grammar School Entry
          </h2>
          <p className="text-sm md:text-base text-white/90 max-w-2xl mx-auto mb-8">
            Structured classes in English, Maths, Verbal and Non-Verbal Reasoning to help your child
            feel confident, exam-ready, and excited for the next step.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <button
              ...
              aria-label="Book 11+ classes"
            >
              <span className="relative z-10">Book 11+ Classes</span>
            </button>
            <button
              ...
              aria-label="View 11+ specialist classes"
            >
              View Specialist Classes
            </button>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <p className="text-sm md:text-base text-gray-600 leading-relaxed mb-6">
              The 11+ Common Entrance Examinations are formulated by the CEM or GL boards mainly
              (ISEB) and taken mainly by students to enter the Grammar schools at the end of year 5.
              Children at the age of 11+ are required to sit examinations in English, Mathematics,
              Verbal Reasoning and Non Verbal Reasoning, Mathematics and Science in November and
              January of Year 6 prior to entry to senior school the following September.
            </p>
...
export default ElevenPlusPreparation
